...
const Disclaimer = () => {
  return (
    <div className="min-h-screen py-16 px-6 sm:px-12 lg:px-24 text-gray-100 mt-20">
      <div className="max-w-4xl mx-auto bg-[#020617] shadow-2xl rounded-2xl p-5 sm:p-10 border border-gray-700">
        {/* Title */}
        <h1 className="text-4xl font-extrabold mb-10 text-[#16A085] text-center tracking-wide">
          Disclaimer
        </h1>

        {/* Numbered List */}
        <ol className="list-decimal list-inside space-y-6 text-[#CBD5E1] leading-relaxed text-lg">
          <li>
            The insights, research, and recommendations offered by{" "}
            <span className="text-[#16A085] font-medium">Behind The Profit</span>{" "}
