  ...
  return (
    <header className="bg-[#F2F2F2] backdrop-blur-lg w-full fixed top-0 right-0 left-0 mx-auto z-10 h-18">
      ...
      <nav className="flex justify-between items-center mx-4 -mt-5">
        ...
        {/* Mobile Toggle */}
        <div className="text-[#020617] lg:hidden text-[20px]">
        ...
        {/* Desktop Menu */}
        <div className="bg-[#0F172A] rounded-full px-4 py-3 md:space-x-6 lg:text-[16px] font-semibold hidden lg:block">
        ...
        {/* Call Info */}
        <div className="text-white space-x-4 lg:text-[16px] text-[17px] hidden lg:block font-semibold">
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden absolute top-25 left-0 w-full bg-[#F2F2F2] z-20 transition-all duration-500 ease-in-out">
          <div className="text-[#020617] ml-5 flex flex-col items-start justify-start space-y-2 py-2 lg:text-[18px]">
            {menuItems.map((item, index) => (
              <NavLink
                key={index}
                to={item.to}
