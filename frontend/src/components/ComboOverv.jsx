    ...
    <section className="text-white">
      ...
      <div className="relative w-full h-125 sm:h-150 lg:h-175">
        ...
        <div className="absolute inset-0 bg-[#0F172A] bg-opacity-60 flex flex-col justify-center items-center text-center px-6 sm:px-12">
          ...
          <p className="text-lg sm:text-xl text-[#CBD5E1] max-w-3xl mb-6">
      ...
      <div className="max-w-6xl mx-auto py-16 px-6 sm:px-12 lg:px-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-xl font-bold mb-2 text-[#16A085]">Dual Focus</h3>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-xl font-bold mb-2 text-[#16A085]">Diversified Approach</h3>
            <p className="text-[#CBD5E1]">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            ...
            <h3 className="text-xl font-bold mb-2 text-[#16A085]">Risk-Adjusted Returns</h3>
            <p className="text-[#CBD5E1]">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {[
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2 text-[#16A085]">{f.title}</h3>
                <p className="text-[#CBD5E1]">{f.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="max-w-6xl mx-auto mb-16 px-6 sm:px-12 lg:px-20">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-lg leading-relaxed">
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="font-bold text-xl mb-2 text-[#16A085]">Capital Allocation</h3>
            <p className="text-[#CBD5E1]">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="font-bold text-xl mb-2 text-[#16A085]">Stock Selection</h3>
            <p className="text-[#CBD5E1]">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="font-bold text-xl mb-2 text-[#16A085]">Monitoring & Adjustments</h3>
            <p className="text-[#CBD5E1]">
              Alpha is tracked daily; Turbo is reviewed quarterly for rebalancing.
            </p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="font-bold text-xl mb-2 text-[#16A085]">Profit Reinvestment</h3>
            <p className="text-[#CBD5E1]">
      ...
      <div className="max-w-5xl mx-auto py-16 px-6 sm:px-12 lg:px-20">
        ...
        <ul className="list-disc list-inside space-y-4 text-[#333] text-lg">
      ...
      <div className="max-w-5xl mx-auto py-16 px-6 sm:px-12 lg:px-20">
        ...
        <ul className="list-disc list-inside space-y-4 text-[#333333] text-lg">
